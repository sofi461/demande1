    ...
    <div className="introo">
      ...
      <div className="p2">
        <div className="ndt">
          ...
          <div className="dh">
            ...
            <input
              type="date"
              id="le"
              value={localStorage.getItem("datep")}
              readOnly
            />
            ...
            <input
              type="time"
              id="a"
              value={localStorage.getItem("dateh")}
              readOnly
            />
          </div>
        </div>
        ...
        <div className="str">
          ...
          {localStorage.getItem("a") === "a" ? (
            <input type="checkbox" id="CDS" checked disabled />
          ) : (
            <input type="checkbox" id="CDS" disabled />
          )}
          ...
          {localStorage.getItem("a") === "a" ? (
            ...
            <input type="text" id="CDS" readOnly />
          )}

          <br />
          {localStorage.getItem("a") === "b" ? (
            <input type="checkbox" id="G" checked disabled />
          ) : (
            <input type="checkbox" id="G" disabled />
          )}
          ...
          {localStorage.getItem("a") === "b" ? (
            ...
            <input type="text" id="G" readOnly />
          )}

          <br />
          {localStorage.getItem("a") === "c" ? (
            <input type="checkbox" id="UNM" checked disabled />
          ) : (
            <input type="checkbox" id="UNM" disabled />
          )}
          ...
          {localStorage.getItem("a") === "c" ? (
            ...
            <input type="text" id="UNM" readOnly />
          )}

          <br />
          {localStorage.getItem("a") === "d" ? (
            <input type="checkbox" id="un" checked disabled />
          ) : (
            <input type="checkbox" id="un" disabled />
          )}
          ...
          <br />
          {localStorage.getItem("a") === "e" ? (
            <input type="checkbox" id="pre" checked disabled />
          ) : (
            <input type="checkbox" id="pre" disabled />
          )}
      ...
      <div className="p3">
        ...
        <div className="ntrpa">
          ...
          <br />
          {localStorage.getItem("nature") === "m" ? (
            <input type="checkbox" id="mec" checked disabled />
          ) : (
            <input type="checkbox" id="mec" disabled />
          )}

          <label htmlFor="mec"> Mécanique</label>
          <br />
          {localStorage.getItem("nature") === "e" ? (
            <input type="checkbox" id="é" checked disabled />
          ) : (
            <input type="checkbox" id="é" disabled />
          )}
          <label htmlFor="é">Electrique</label>
          <br />
          {localStorage.getItem("nature") === "a" ? (
            <input type="checkbox" id="au" checked disabled />
          ) : (
            <input type="checkbox" id="au" disabled />
          )}
      ...
      <button id="apres" onClick={() => navigator("/Partie2")}>
        Suivant
      </button>
    </div>
  )
