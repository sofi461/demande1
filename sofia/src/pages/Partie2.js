...
const Partie2 = () => {
 ...
 <div className="partiee2">
    ...
    <div class="marcs">
<div class="m"><label htmlFor="code">Code :</label>
 <input type="text"  id='codeee' placeholder='...........................'/>
</div>
<div class="ar">
...
<div class="r">
    ...
    <input type="text"  id='mar' placeholder='...........................'/>
</div>
<div class="c">
...
<div class="s">
    ...
    <input type="text"  id='ty' placeholder='...........................'/>
</div>
<div class="vide"></div>
 </div>
 <div class="const"><h4>Constat de la panne </h4></div>
 <textarea  id="es" disabled>{localStorage.getItem("consta")}</textarea>
 <div class="grid">   <div class="dd"><h4 id="d">Demandeur</h4></div> 
 <div class="drr"><h4 id="r">Responsable CDS Autre</h4></div></div>
 <div class="p4">
<div class="pd">
...
<input type="text" id='visar' />
 ...
 <button id="apres" onClick={()=> {navigator("/Partie3" );}}>SUIVANT</button>
 <button id="prece" onClick={()=> navigator("/intro" )}>PRECEDENT</button>
 </div>
    );
};
